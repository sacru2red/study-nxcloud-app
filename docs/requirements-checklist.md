...
**최종 검증 (로컬):** `npx nx run backend-e2e:e2e` 11 passed · `npx nx e2e frontend-e2e` 14 passed (2026-05-22)
...
- [ ] bbox 저장 (스키마만 존재, 추출 미구현 — 선택 항목)
- [ ] Q&A 10초 이내 (목표; [벤치마크](./development.md#rag-응답-시간-벤치마크) 참고)
...
- [x] tenant-a/b 격리
- [x] 업로드·인덱싱·채팅·환각 억제·quota·Nextcloud 인증 실패
- [x] 채팅 diagnostics / API 실패 UI 메시지
